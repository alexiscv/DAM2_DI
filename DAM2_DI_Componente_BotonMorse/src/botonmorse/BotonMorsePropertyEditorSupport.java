 ...
 * @author Alexis
 */
public class BotonMorsePropertyEditorSupport extends PropertyEditorSupport {

    private BotonMorsePanel botonMorsePanel = new BotonMorsePanel();
    ...
    public String getJavaInitializationString() {
        ...
        BotonMorse botonMorse = botonMorsePanel.getValoresPanel();

        if (botonMorse.getDuracionPulsacionCorta() > 0 && botonMorse.getDuracionPulsacionLarga() > botonMorse.getDuracionPulsacionCorta()) {

            int duracionPunto = botonMorse.getDuracionPulsacionCorta();
            int duracionRaya = botonMorse.getDuracionPulsacionCorta();

            String cadena = "new botonmorse.BotonMorse(" + duracionPunto + "," + duracionRaya + ")";
            return cadena;

        } else {

            return "Error, los datos introducidos en la configuración no son válidos.";
    ...
    public Object getValue() {
        return botonMorsePanel.getValoresPanel();
    }
